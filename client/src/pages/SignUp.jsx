...
export default function SignUp() {
  ...
  async function handleSubmit(e) {
    ...
    if (newUser.password === newUser.password_confirmation) {
      const { password_confirmation, ...user } = newUser;
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form
              ...
              className="mt-8 grid grid-cols-6 gap-8"
            >
              <div className="col-span-6">
                ...
                <input
                  ...
                  id="username"
                  name="username"
                  className="mt-1 w-full p-2 outline-none rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                />
              </div>
